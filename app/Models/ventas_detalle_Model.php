...
class ventas_detalle_Model extends Model
{
 ...
 protected $allowedFields = ['venta_id','producto_detalle_id','cantidad', 'precio', 'subtotal']; //todos los campos de la tabla

public function listarVentasDetalle($idVenta){
        return $this->select('ventas_detalle.*, productos.nombre_producto, talles.talle, colores.nombre as color')
